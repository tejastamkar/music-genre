...
def predict():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            scaler = pickle.load(open('src/pickle/scalar.pkl', 'rb'))
            X_train = pickle.load(open('src/pickle/xtrain.pkl', 'rb'))
            ...
            cbc = pickle.load(open('src/pickle/cbc.pkl', 'rb'))
            xgbc = pickle.load(open('src/pickle/cbc.pkl', 'rb'))
            # change xgbc later
            gbc = pickle.load(open('src/pickle/gbc.pkl', 'rb'))
            abc = pickle.load(open('src/pickle/abc.pkl', 'rb'))
            rfc = pickle.load(open('src/pickle/rfc.pkl', 'rb'))
            lr = pickle.load(open('src/pickle/lr.pkl', 'rb'))
            cls = pickle.load(open('src/pickle/cls.pkl', 'rb'))
